document.addEventListener("DOMContentLoaded", function() {
    ...
    projectLinks.forEach(link => {
        link.addEventListener('click', (event) => {
            ...
            // Si el contenido actual ya está visible, lo ocultamos
            if (projectDetails.dataset.currentProject === project) {
                projectDetails.style.display = 'none';
                projectDetails.dataset.currentProject = '';
            } else {
                displayProjectDetails(project);
                projectDetails.dataset.currentProject = project; // Guardamos el proyecto actual
            }
        });
    });
        ...
        switch(project) {
            case 'backend':
                projectContent = `
                    ...
                    <div class="buttons">
                        <p>Esta página no ha sido publicada</p>
